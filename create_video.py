...
def create_poster(
    ...
    # Use an English-only reference badge so Arabic/Urdu glyph issues
    # cannot produce square/tofu characters in the reference.
    ...
    surah_names_en = {
        1: "Al-Fatiha", 2: "Al-Baqarah", 3: "Aal-E-Imran",
        ...
        17: "Al-Isra", 18: "Al-Kahf", 19: "Maryam",
        20: "Ta-Ha", 21: "Al-Anbiya", 22: "Al-Hajj",
        23: "Al-Mu'minun", 24: "An-Nur", 25: "Al-Furqan",
        26: "Ash-Shu'ara", 27: "An-Naml", 28: "Al-Qasas",
        29: "Al-Ankabut", 30: "Ar-Rum", 31: "Luqman",
        32: "As-Sajdah", 33: "Al-Ahzab", 34: "Saba",
        35: "Fatir", 36: "Ya-Sin", 37: "As-Saffat",
        38: "Sad", 39: "Az-Zumar", 40: "Ghafir",
        41: "Fussilat", 42: "Ash-Shura", 43: "Az-Zukhruf",
        44: "Ad-Dukhan", 45: "Al-Jathiyah", 46: "Al-Ahqaf",
        47: "Muhammad", 48: "Al-Fath", 49: "Al-Hujurat",
        50: "Qaf", 51: "Adh-Dhariyat", 52: "At-Tur",
        53: "An-Najm", 54: "Al-Qamar", 55: "Ar-Rahman",
        56: "Al-Waqi'ah", 57: "Al-Hadid", 58: "Al-Mujadilah",
        59: "Al-Hashr", 60: "Al-Mumtahanah", 61: "As-Saff",
        62: "Al-Jumu'ah", 63: "Al-Munafiqun", 64: "At-Taghabun",
        65: "At-Talaq", 66: "At-Tahrim", 67: "Al-Mulk",
        68: "Al-Qalam", 69: "Al-Haqqah", 70: "Al-Ma'arij",
        71: "Nuh", 72: "Al-Jinn", 73: "Al-Muzzammil",
        ...
        86: "At-Tariq", 87: "Al-A'la", 88: "Al-Ghashiyah",
        89: "Al-Fajr", 90: "Al-Balad", 91: "Ash-Shams",
        92: "Al-Layl", 93: "Ad-Duha", 94: "Ash-Sharh",
    ...
    surah_number = int(
        get_dua_field(dua, "sura", "surah", default="0")
    )
    surah_name_en = surah_names_en.get(
        surah_number,
        "Quran"
    )

    ayah_number = int(
        get_dua_field(dua, "ayah", "aya", "verse", default="0")
    )
    ayah_end_number = int(
        get_dua_field(dua, "ayah_end", "aya_end", default=ayah_number)
    )

    ayah_reference = (
        f"{ayah_number}"
        if ayah_end_number == ayah_number
        else f"{ayah_number}-{ayah_end_number}"
    )

    ref_text = (
        f"Quran • Surah {surah_name_en} • {ayah_reference}"
    )
